...
int main() {
    // Llama a la función FormLetter() para imprimir la forma de letra 'Z' con 0 espacios iniciales y el contador inicializado en 9.
    FormLetter(0, 9);
    return 0;
}
...
void FormLetter(int space, int counter) {
    if(counter == 9) {
        ...
        LetterZ(1); // Llama a LetterZ() para imprimir una 'Z' en la primera fila.
        printf("\n"); // Imprime un salto de línea.
        FormLetter(space + 1, counter - 1); // Llama recursivamente a FormLetter() con más espacio entre columnas y un contador decreciente.
    } else if(counter > 0) {
        Spaces(counter); // Llama a Spaces() para imprimir espacios iniciales.
        ...
        printf("\n"); // Imprime un salto de línea.
        FormLetter(space + 2, counter - 1); // Llama recursivamente a FormLetter() con más espacio entre columnas y un contador decreciente.
    } else {
        Spaces(counter); // Llama a Spaces() para imprimir espacios iniciales.
